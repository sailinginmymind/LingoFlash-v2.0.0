...
const QuizManager = {
    ...
    /**
     * Genera il report finale e salva automaticamente le statistiche 
     * di lungo periodo (Media, Record, Trend) nello StorageManager.
     * @param {string} folderId - L'ID della cartella completata
     */
    getReport(folderId = null) {
        ...
        const report = {
            ...
            paroleSbagliate: this.session.paroleSbagliate
        };

        // EVOLUZIONE DATI: Se passiamo l'ID cartella, salviamo i progressi storici
        if (folderId && typeof StorageManager !== 'undefined') {
            StorageManager.saveSessionStats(folderId, percentuale);
        }
